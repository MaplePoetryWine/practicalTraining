...
/**
 * @author wspstart
 * @create 2022-06-24 12:22
 */
public class CreditAccoutServic {
    private CreditAccount creditAccount ;
    String FILENAME = "src\\CreditAccount.txt";
    String REPACEFILENAME ="src\\CreditAccountcopy.txt";
            ...
            if (key == ID){
                ...
                for (Integer key1 : integers){
                    if (key1 == ID){
                        ...
                        double deleted = creditAccount.getBalance();
                        creditAccount.setBalance(creditAccount.getBalance() - money);
                        ReadWriteFile.replace(FILENAME,REPACEFILENAME,String.valueOf(deleted),2,String.valueOf(creditAccount.getBalance()));
